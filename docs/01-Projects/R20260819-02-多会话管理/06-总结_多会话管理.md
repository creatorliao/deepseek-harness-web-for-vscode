...
- **全局 button 样式污染修复**（Gemini 定位，见 `docs/01-Projects/R20260819-02-多会话管理/09-修复_会话按钮横向偏移.md`）：会话按钮显式内联 20×20 免疫全局 `button {width:100%}`，操作区绝对定位锚定行右缘；
...
`docs/01-Projects/R20260819-02-多会话管理/`：discussion / req（R1–R2 + D1–D7）/ solution（含 §8 评审吸收）/ plan（T1–T9）/ review-by-gemini（二轮 APPROVED）/ verification / TODO；`docs/01-Projects/R20260819-02-多会话管理/09-修复_会话按钮横向偏移.md`（analysis-by-gemini + record）。
...
*关联文档：verification.md ｜ TODO.md ｜ plan.md ｜ review-by-gemini.md ｜ docs/01-Projects/R20260819-02-多会话管理/09-修复_会话按钮横向偏移.md*
