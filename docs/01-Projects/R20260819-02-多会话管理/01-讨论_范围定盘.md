...
- 来源：[roadmap.md](../R20260914-01-演进总览/02-路线图.md) **M2**、[全局 TODO.md](../R20260914-01-演进总览/03-待办总表.md) **G-12**、[product-strategy.md](../../02-Areas/20260914-09-产品定位与边界.md) §5；
...
- feature 01 的 [req.md](../R20260819-01-工作区对齐/02-需求_工作区对齐.md) R3 写的是"推迟为 **feature 03**（原 roadmap M2）"——**编号不一致**；
