...
本文档为**提案**，落盘于 `docs/01-Projects/R20260817-01-桥架构与IDE内嵌/09-架构提案_by-deepseek.md`。评审通过后按仓库 Feature Pipeline 进入
`docs/01-Projects/R20260817-01-桥架构与IDE内嵌/{discussion,req,solution,plan}.md` 继续。
