...
`docs/01-Projects/R20260817-01-桥架构与IDE内嵌/09-架构提案_by-deepseek.md`、`docs/03-Resources/20260817-01-市场与竞品数据快照.md`、`docs/01-Projects/R20260817-01-桥架构与IDE内嵌/`（discussion/req/solution/plan/spike-notes/verification/TODO/summary）、`docs/01-Projects/R20260817-01-桥架构与IDE内嵌/11-修复_vsix缺少ws依赖.md`、`docs/02-Areas/`、`Makefile`。
...
见 [TODO.md](07-待办_MVP延后项.md)（T13–T18，⏭️ 延后）：共享实例探测、Abort 传递、下载流式、版本固化、settings 镜像/上游、主题重载兜底。
...
*关联文档：verification.md ｜ TODO.md ｜ plan.md ｜ docs/02-Areas/20260914-07-发布与版本规范.md*
