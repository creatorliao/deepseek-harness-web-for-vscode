# DSH × VS Code 扩展 —— 市场分析（2026-08-17 数据快照）

**日期**: 2026-08-17（数据采集日）｜ **状态**: 数据快照（**判断已闭合，数据已过期**）
**归属**: 外部参考资料 —— 该不该做 / 卖给谁 / 凭什么赢 / 怎么衡量成功

> ⚠️ **使用提示**：本文所有安装量 / star / 下载量均为 **2026-08-17 当日实拉**，此后未再更新。"该不该做"的判断**已经闭合**（扩展已上线并发布至 0.3.4），本文现在只作**决策依据的历史留档**与市场数据参考。
> 现行的产品方向见 [产品定位与边界](../02-Areas/20260914-09-产品定位与边界.md)；当前状态见 [路线图](../01-Projects/R20260914-01-演进总览/02-路线图.md)。
>
> 前置文档：[架构提案（DeepSeek）](../01-Projects/R20260817-01-桥架构与IDE内嵌/09-架构提案_by-deepseek.md)
...
*关联文档：[架构提案（DeepSeek）](../01-Projects/R20260817-01-桥架构与IDE内嵌/09-架构提案_by-deepseek.md) ｜ [需求：MVP](../01-Projects/R20260817-01-桥架构与IDE内嵌/02-需求_MVP.md) ｜ [产品定位与边界](../02-Areas/20260914-09-产品定位与边界.md)*
